...
namespace CatalogResource
{
    public class ObjectDefinitionResource : AResource
    {
        ...
        #region Constructors
        public ObjectDefinitionResource(int APIversion, Stream s)
            : base(APIversion, s)
        {
            this.Parse(s);
        }
        ...
        protected override Stream UnParse()
        {
            ...
            for (int i = 0; i < this.propertyIDList.Count; i++)
            {
                ...
                {
                    case PropertyID.Name:
                        this.WriteString(w, this.name);
                        break;
                    case PropertyID.Tuning:
                        this.WriteString(w, this.tuning);
                        break;
                    case PropertyID.TuningID:
                        w.Write(this.tuningID);
                        break;
                    case PropertyID.Icon:
                        this.WriteTGIBlock(w, this.icon);
                        break;
                    case PropertyID.Rig:
                        this.WriteTGIBlock(w, this.rig);
                        break;
                    case PropertyID.Slot:
                        this.WriteTGIBlock(w, this.slot);
                        break;
                    case PropertyID.Model:
                        this.WriteTGIBlock(w, this.model);
                        break;
                    case PropertyID.Footprint:
                        this.WriteTGIBlock(w, this.footprint);
                        break;
                    case PropertyID.Components:
                        ...
                        break;
                    case PropertyID.MaterialVariant:
                        this.WriteString(w, this.materialVariant);
                        break;
                    case PropertyID.Unknown1:
        ...
        [ElementPriority(0)]
        public ushort Version { get { return this.version; } }
        ...
        {
            get { if (!this.propertyIDList.Contains(PropertyID.Tuning)) { throw new InvalidDataException(); } return this.tuning; }
            set
            {
                if (!value.Equals(this.tuning))
                {
                    this.tuning = value;
                    this.OnResourceChanged(this, EventArgs.Empty);
                }
        ...
        {
            get { if (!this.propertyIDList.Contains(PropertyID.TuningID)) { throw new InvalidDataException(); } return this.tuningID; }
            set
            {
                if (!value.Equals(this.tuningID))
                {
                    this.tuningID = value;
                    this.OnResourceChanged(this, EventArgs.Empty);
                }
        ...
        public bool IsBaby
        {
            get { if (!this.propertyIDList.Contains(PropertyID.IsBaby)) { throw new InvalidDataException(); } return this.isBaby; }
            set
            {
                if (!value.Equals(this.isBaby))
                {
                    this.isBaby = value;
                    this.OnResourceChanged(this, EventArgs.Empty);
                }
        ...
        [ElementPriority(5)]
        public SimpleList<UInt32> Components
        {
            get { if (!this.propertyIDList.Contains(PropertyID.Components)) { throw new InvalidDataException(); } return this.components; }
            set
            {
                if (!value.Equals(this.components))
                {
        ...
        {
            get { if (!this.propertyIDList.Contains(PropertyID.MaterialVariant)) { throw new InvalidDataException(); } return this.materialVariant; }
            set
            {
                if (!value.Equals(this.materialVariant))
                {
                    this.materialVariant = value;
                    this.OnResourceChanged(this, EventArgs.Empty);
                }
            }
        }
        ...
        [ElementPriority(7)]
        public UInt32 SimoleonPrice
        {
            get { if (!this.propertyIDList.Contains(PropertyID.SimoleonPrice)) { throw new InvalidDataException(); } return this.simoleonPrice; }
            set
            {
                if (!value.Equals(this.simoleonPrice))
                {
                    this.simoleonPrice = value;
                    this.OnResourceChanged(this, EventArgs.Empty);
                }
            }
        }
        ...
        [ElementPriority(8)]
        public float PositiveEnvironmentScore
        {
            get { if (!this.propertyIDList.Contains(PropertyID.PositiveEnvironmentScore)) { throw new InvalidDataException(); } return this.positiveEnvironmentScore; }
            set
            {
                if (!value.Equals(this.positiveEnvironmentScore))
                {
                    this.positiveEnvironmentScore = value;
                    this.OnResourceChanged(this, EventArgs.Empty);
                }
            }
        }
        ...
        [ElementPriority(9)]
        public float NegativeEnvironmentScore
        {
            get { if (!this.propertyIDList.Contains(PropertyID.NegativeEnvironmentScore)) { throw new InvalidDataException(); } return this.negativeEnvironmentScore; }
            set
            {
                if (!value.Equals(this.negativeEnvironmentScore))
                {
                    this.negativeEnvironmentScore = value;
                    this.OnResourceChanged(this, EventArgs.Empty);
                }
            }
        }
        ...
        [ElementPriority(10)]
        public UInt32 ThumbnailGeometryState
        {
            get { if (!this.propertyIDList.Contains(PropertyID.ThumbnailGeometryState)) { throw new InvalidDataException(); } return this.thumbnailGeometryState; }
            set
            {
                if (!value.Equals(this.thumbnailGeometryState))
                {
                    this.thumbnailGeometryState = value;
                    this.OnResourceChanged(this, EventArgs.Empty);
                }
            }
        }
        ...
        [ElementPriority(11)]
        public CatalogTagList EnvironmentScoreEmotionTags
        {
            get { if (!this.propertyIDList.Contains(PropertyID.EnvironmentScoreEmotionTags)) { throw new InvalidDataException(); } return this.environmentScoreEmotionTags; }
            set
            {
                if (!value.Equals(this.environmentScoreEmotionTags))
                {
                    this.environmentScoreEmotionTags = value;
                    this.OnResourceChanged(this, EventArgs.Empty);
                }
            }
        }
        ...
        [ElementPriority(12)]
        public float[] EnvironmentScores
        {
            get { if (!this.propertyIDList.Contains(PropertyID.EnvironmentScores)) { throw new InvalidDataException(); } return this.environmentScores; }
            set
            {
                if (!value.Equals(this.environmentScores))
                {
                    this.environmentScores = value;
                    this.OnResourceChanged(this, EventArgs.Empty);
                }
            }
        }
        ...
        [ElementPriority(13)]
        public TGIBlockList Icon
        {
            get { if (!this.propertyIDList.Contains(PropertyID.Icon)) { throw new InvalidDataException(); } return this.icon; }
            set
            {
                if (!value.Equals(this.icon))
                {
                    this.icon = value;
                    this.OnResourceChanged(this, EventArgs.Empty);
                }
        ...
        [ElementPriority(14)]
        public TGIBlockList Rig
        {
            get { if (!this.propertyIDList.Contains(PropertyID.Rig)) { throw new InvalidDataException(); } return this.rig; }
            set
            {
                if (!value.Equals(this.rig))
                {
                    this.rig = value;
                    this.OnResourceChanged(this, EventArgs.Empty);
                }
        ...
        [ElementPriority(15)]
        public TGIBlockList Slot
        {
            get { if (!this.propertyIDList.Contains(PropertyID.Slot)) { throw new InvalidDataException(); } return this.slot; }
            set
            {
                if (!value.Equals(this.slot))
                {
                    this.slot = value;
                    this.OnResourceChanged(this, EventArgs.Empty);
                }
        ...
        [ElementPriority(16)]
        public TGIBlockList Model
        {
            get { if (!this.propertyIDList.Contains(PropertyID.Model)) { throw new InvalidDataException(); } return this.model; }
            set
            {
                if (!value.Equals(this.model))
                {
                    this.model = value;
                    this.OnResourceChanged(this, EventArgs.Empty);
                }
        ...
        [ElementPriority(17)]
        public TGIBlockList Footprint
        {
            get { if (!this.propertyIDList.Contains(PropertyID.Footprint)) { throw new InvalidDataException(); } return this.footprint; }
            set
            {
                if (!value.Equals(this.footprint))
                {
    ...
    public class ObjectDefinitionResourceHandler : AResourceHandler
    {
        ...
        {
            this.Add(typeof(ObjectDefinitionResource), new List<string>(new[] { "0xC0DB5AE7", }));
        }
    }
}
